...
abstract class Abstract_Integration {
	...
	protected function get_token() {
		// Each native form carries its own nonce; the captcha token is separate.
		return isset( $_POST['cf-turnstile-response'] ) // phpcs:ignore WordPress.Security.NonceVerification.Missing

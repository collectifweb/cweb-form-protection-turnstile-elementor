...
namespace TurnstileForms\Elementor;

use ElementorPro\Modules\Forms\Fields\Field_Base;
use TurnstileForms\Settings;
use TurnstileForms\Verifier;
use TurnstileForms\Widget_Renderer;
...
class Turnstile_Field extends Field_Base {
	...
	public function get_name() {
		return esc_html__( 'Cloudflare Turnstile', 'captcha-field-for-turnstile' );
	}
	...
	public function validation( $field, $record, $ajax_handler ) {
		...
		$token = isset( $_POST['cf-turnstile-response'] ) // phpcs:ignore WordPress.Security.NonceVerification.Missing -- Elementor handles its own form nonce; this is the captcha token.

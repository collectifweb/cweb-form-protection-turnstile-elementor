...
2. Activate it.
3. Go to **Settings → Turnstile Forms** and enter your Cloudflare **site key** and **secret key**.
...
No. If that plugin's settings are present, the **Settings → Turnstile Forms** page shows an "Import keys & settings" button that copies your site key, secret key, appearance options and form toggles over. Your existing Cloudflare keys keep working — nothing is regenerated, and the other plugin is left untouched.

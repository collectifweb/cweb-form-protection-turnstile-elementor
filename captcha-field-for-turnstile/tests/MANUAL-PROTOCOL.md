...
3. **Settings → Turnstile Forms**: enter the *always passes* site/secret keys.
...
- [ ] Deactivate + delete the plugin → `turnstile_forms_settings` option is removed (check the options table).

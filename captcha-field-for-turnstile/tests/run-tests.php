...
tf_reset();
$GLOBALS['__tf']['filters']['turnstile_forms_remoteip'] = 'not-an-ip';
tf_verifier()->verify( 'tok' );
t( 'invalid remoteip is omitted', ! isset( $GLOBALS['__tf']['http']['last']['body']['remoteip'] ) );
tf_reset();
$GLOBALS['__tf']['filters']['turnstile_forms_remoteip'] = '';
tf_verifier()->verify( 'tok' );
...
tf_reset();
$GLOBALS['__tf']['http']['body']                          = '{"success":true,"action":"elementor_form"}';
$GLOBALS['__tf']['filters']['turnstile_forms_verify_action'] = true;
...
$GLOBALS['__tf']['filters']['turnstile_forms_verify_hostname'] = true;
...
$saved = get_option( 'turnstile_forms_settings' );
